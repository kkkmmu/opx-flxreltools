...
class DaemonObjectsInfo (object) :
    ...
    def addGeneratedFilesNamesToListing (self, dmn):
...
//                                                                                                           
    ...
    def clientIfBasicHelper(self, clientIfFd):
        ...
        clientIfFd.write("""
                            func (clnt *%sClient) Initialize(name string, address string, logger logging.LoggerIntf, paramsDir string) {
                                clnt.Name = name
...
def generateThriftAndClientIfs():
    ...
    for dmn, entry in ownerToObjMap.iteritems():
        ...
        entry.addGeneratedFilesNamesToListing (dmn)
        #if dmn == 'asicd': 
